...
entryPoint:
    ...
    .while 1
        .if [targetDir] <> RADAR_INVALIDRAY
            mov r6, [targetDir]
        .elseif [friendDir] <> RADAR_INVALIDRAY
            mov r6, [friendDir]
            mul r6, 3

            ; stop moving if near a friend
            .if word [r6 + radarData + 1] <= [reverseDist]
...
radarInterruptHandler:
    ...
    mov r4, RADAR_INVALIDRAY    ; friend dir
    mov r5, RADAR_INVALIDDIST   ; friend dist
    mov r6, RADAR_INVALIDRAY    ; target dir
    mov r7, RADAR_INVALIDDIST   ; target dist
...
;   if (heading != moveDir) {
;       int direction = getTurnDirection(heading, moveDir);
